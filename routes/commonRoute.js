...
router.get('/about-us', async(req,res) =>{
    const {cartData,cartCount } = await getCartData(req);
    const catData = await getAllCategory()
    res.render('about-us',{cartData,cartCount,catData})
});

router.get('/contact-us', async(req,res) =>{
    const {cartData,cartCount } = await getCartData(req);
    const catData = await getAllCategory()
    res.render('contact-us', {cartData,cartCount,catData})
});
 
router.get('/term-condition', async(req,res) =>{
    const {cartData,cartCount } = await getCartData(req)
    const catData = await getAllCategory()
    res.render('term-condition',{cartData,cartCount,catData })
})

router.get('/privacy-policy', async(req,res) =>{
    const {cartData,cartCount } = await getCartData(req)
    const catData = await getAllCategory()
    res.render('privacy-policy',{cartData,cartCount,catData })
})

router.get('/user-guideline', async(req,res) =>{
    const {cartData,cartCount } = await getCartData(req)
    const catData = await getAllCategory()
    res.render('user-guideline',{cartData,cartCount,catData })
})
router.get('/cookie-policy', async(req,res) =>{
    const {cartData,cartCount } = await getCartData(req)
    const catData = await getAllCategory()
    res.render('cookie-policy',{cartData,cartCount,catData })
})
 
router.get('/refund-policy', async(req,res) =>{
    const {cartData,cartCount } = await getCartData(req)
    const catData = await getAllCategory()
    res.render('refund-policy',{cartData,cartCount,catData})
})
